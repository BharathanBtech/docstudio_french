...
let campaigns = [
  {
    ...
    bouncedCount: 5,
    smsSentCount: 5,
    // Scheduling fields (using snake_case to match real API)
  ...
  },
  {
    ...
    emailTemplateId: 'email-1',
    emailTemplateName: 'Appointment Reminder',
    smsTemplateId: null,
    smsTemplateName: null,
    enableSmsFailover: true,
    csvData: [],
    ...
    bouncedCount: 0,
    smsSentCount: 0,
    // Scheduling fields - this one should show "Not Set" since both are false/null
    sendimmediately: false,
    scheduledat: null
  }
];
...
app.post('/campaigns', (req, res) => {
  const { name, description, emailTemplateId, smsTemplateId, enableSmsFailover, csvData, sendImmediately, scheduledAt } = req.body;
  ...
  const newCampaign = {
    ...
    smsSentCount: 0,
    // Scheduling fields (using snake_case to match real API)
    sendimmediately: sendImmediately !== undefined ? sendImmediately : true,
